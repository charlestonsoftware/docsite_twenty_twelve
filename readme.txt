...
== Description ==
A child theme for WordPress Twenty Twelve with some documentation site updates.

== Installation ==

1. Go fetch and install the WordPress TwentyTwelve theme.
...
2. Install the Twenty Twelve Docsite theme and activate it:
